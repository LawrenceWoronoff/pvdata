...
<div>
    <main class="Main" data-amp-auto-lightbox-disable="" id="content">
        <section class="c--text-inverse py700 section" style="background-image: url('assets/Website-Image-cropped.jpg');">
            <div class="flex-column flex-row-l items-center-l row" style="justify-content: flex-end;">
                <div class="col mw-41p-l mw-66p-m mx-auto pb600-m px350-ns px450 w-100p" style="margin-left:0px;">
                    ...
                    <a class="Button--large button mt500-l mt600 w-100p w-auto-l" id="downloadFree" target="_blank">Download For Free </a>
        ...
        <section class="bg--teal-500 py700 py750-ns section" style="padding-bottom: 0px;">
            <div class="flex-column flex-row-l row">
                <div class="col mw-41p-l mw-83p-m mx-auto px350-ns px450 w-100p">
                    ...
                    PvData customers are industry leaders who embrace due diligence reporting as a vital part of their overall business strategies; and a key to addressing solar energy bankability. </p>
                </div>
        ...
        <section class="c--text-inverse py700 section bg--blue-700" style="padding: 100px 0px; height: 100%; color: white;">
            <h2 class="text-white text-align-center">Read what our customers say</h2>

            <div class="flex-wrap row h-100p">
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    ...
                    <p class="comment-text">PVDATA just did it! This is truly a remarkable platform that for sure will allow us to move projects much faster while cutting down the cost of doing so. We are extremely pleased by it and strongly recommend for usage in the Renewable Energy domain. </p>
                    <p class="customer-name">Balajee Rangarajan</p>
                    <p class="customer-job">Director Solon</p>
                </div>
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    <span class="u-align-left u-icon u-icon-circle u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 95.333 95.332" style=""><use xlink:href="#svg-a13b"></use></svg><svg class="u-svg-content" viewBox="0 0 95.333 95.332" x="0px" y="0px" id="svg-a13b" style="enable-background:new 0 0 95.333 95.332;"><g><g><path d="M30.512,43.939c-2.348-0.676-4.696-1.019-6.98-1.019c-3.527,0-6.47,0.806-8.752,1.793    c2.2-8.054,7.485-21.951,18.013-23.516c0.975-0.145,1.774-0.85,2.04-1.799l2.301-8.23c0.194-0.696,0.079-1.441-0.318-2.045    s-1.035-1.007-1.75-1.105c-0.777-0.106-1.569-0.16-2.354-0.16c-12.637,0-25.152,13.19-30.433,32.076    c-3.1,11.08-4.009,27.738,3.627,38.223c4.273,5.867,10.507,9,18.529,9.313c0.033,0.001,0.065,0.002,0.098,0.002    c9.898,0,18.675-6.666,21.345-16.209c1.595-5.705,0.874-11.688-2.032-16.851C40.971,49.307,36.236,45.586,30.512,43.939z"></path><path d="M92.471,54.413c-2.875-5.106-7.61-8.827-13.334-10.474c-2.348-0.676-4.696-1.019-6.979-1.019    c-3.527,0-6.471,0.806-8.753,1.793c2.2-8.054,7.485-21.951,18.014-23.516c0.975-0.145,1.773-0.85,2.04-1.799l2.301-8.23    c0.194-0.696,0.079-1.441-0.318-2.045c-0.396-0.604-1.034-1.007-1.75-1.105c-0.776-0.106-1.568-0.16-2.354-0.16    c-12.637,0-25.152,13.19-30.434,32.076c-3.099,11.08-4.008,27.738,3.629,38.225c4.272,5.866,10.507,9,18.528,9.312    c0.033,0.001,0.065,0.002,0.099,0.002c9.897,0,18.675-6.666,21.345-16.209C96.098,65.559,95.376,59.575,92.471,54.413z"></path></g></g></svg></span>

                    <p class="comment-text">The PVDATA tool was an original Imperial College London research. This tool combines the nexus of energy, finance, and environment relating to renewable solar.</p>
                    <p class="customer-name">Professor Nick Voulvoulis</p>
                    <p class="customer-job">Imperial College London</p>
                </div>
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    <span class="u-align-left u-icon u-icon-circle u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 95.333 95.332" style=""><use xlink:href="#svg-a13b"></use></svg><svg class="u-svg-content" viewBox="0 0 95.333 95.332" x="0px" y="0px" id="svg-a13b" style="enable-background:new 0 0 95.333 95.332;"><g><g><path d="M30.512,43.939c-2.348-0.676-4.696-1.019-6.98-1.019c-3.527,0-6.47,0.806-8.752,1.793    c2.2-8.054,7.485-21.951,18.013-23.516c0.975-0.145,1.774-0.85,2.04-1.799l2.301-8.23c0.194-0.696,0.079-1.441-0.318-2.045    s-1.035-1.007-1.75-1.105c-0.777-0.106-1.569-0.16-2.354-0.16c-12.637,0-25.152,13.19-30.433,32.076    c-3.1,11.08-4.009,27.738,3.627,38.223c4.273,5.867,10.507,9,18.529,9.313c0.033,0.001,0.065,0.002,0.098,0.002    c9.898,0,18.675-6.666,21.345-16.209c1.595-5.705,0.874-11.688-2.032-16.851C40.971,49.307,36.236,45.586,30.512,43.939z"></path><path d="M92.471,54.413c-2.875-5.106-7.61-8.827-13.334-10.474c-2.348-0.676-4.696-1.019-6.979-1.019    c-3.527,0-6.471,0.806-8.753,1.793c2.2-8.054,7.485-21.951,18.014-23.516c0.975-0.145,1.773-0.85,2.04-1.799l2.301-8.23    c0.194-0.696,0.079-1.441-0.318-2.045c-0.396-0.604-1.034-1.007-1.75-1.105c-0.776-0.106-1.568-0.16-2.354-0.16    c-12.637,0-25.152,13.19-30.434,32.076c-3.099,11.08-4.008,27.738,3.629,38.225c4.272,5.866,10.507,9,18.528,9.312    c0.033,0.001,0.065,0.002,0.099,0.002c9.897,0,18.675-6.666,21.345-16.209C96.098,65.559,95.376,59.575,92.471,54.413z"></path></g></g></svg></span>

                    <p class="comment-text">PVDATA has made my job a lot easier. I am now able to quickly and efficiently analyse a large number of solar projects in a short amount of time. This has made the decision-making process a lot quicker.  </p>
                    <p class="customer-name">Tim Mole</p>
                    <p class="customer-job">Director Lightsource BP</p>
                </div>
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    <span class="u-align-left u-icon u-icon-circle u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 95.333 95.332" style=""><use xlink:href="#svg-a13b"></use></svg><svg class="u-svg-content" viewBox="0 0 95.333 95.332" x="0px" y="0px" id="svg-a13b" style="enable-background:new 0 0 95.333 95.332;"><g><g><path d="M30.512,43.939c-2.348-0.676-4.696-1.019-6.98-1.019c-3.527,0-6.47,0.806-8.752,1.793    c2.2-8.054,7.485-21.951,18.013-23.516c0.975-0.145,1.774-0.85,2.04-1.799l2.301-8.23c0.194-0.696,0.079-1.441-0.318-2.045    s-1.035-1.007-1.75-1.105c-0.777-0.106-1.569-0.16-2.354-0.16c-12.637,0-25.152,13.19-30.433,32.076    c-3.1,11.08-4.009,27.738,3.627,38.223c4.273,5.867,10.507,9,18.529,9.313c0.033,0.001,0.065,0.002,0.098,0.002    c9.898,0,18.675-6.666,21.345-16.209c1.595-5.705,0.874-11.688-2.032-16.851C40.971,49.307,36.236,45.586,30.512,43.939z"></path><path d="M92.471,54.413c-2.875-5.106-7.61-8.827-13.334-10.474c-2.348-0.676-4.696-1.019-6.979-1.019    c-3.527,0-6.471,0.806-8.753,1.793c2.2-8.054,7.485-21.951,18.014-23.516c0.975-0.145,1.773-0.85,2.04-1.799l2.301-8.23    c0.194-0.696,0.079-1.441-0.318-2.045c-0.396-0.604-1.034-1.007-1.75-1.105c-0.776-0.106-1.568-0.16-2.354-0.16    c-12.637,0-25.152,13.19-30.434,32.076c-3.099,11.08-4.008,27.738,3.629,38.225c4.272,5.866,10.507,9,18.528,9.312    c0.033,0.001,0.065,0.002,0.099,0.002c9.897,0,18.675-6.666,21.345-16.209C96.098,65.559,95.376,59.575,92.471,54.413z"></path></g></g></svg></span>

                    <p class="comment-text">PVDATA has provided me with a holistic insight of all the factors that can potential affect my solar investment. I am now able to get useful country and environmental data about my project during the planning stage. This tool will save me a lot of money and time.</p>
                    <p class="customer-name">Fadekunayo Adeniyi</p>
                    <p class="customer-job">Climate change consultant AfDB</p>
                </div>
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    <span class="u-align-left u-icon u-icon-circle u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 95.333 95.332" style=""><use xlink:href="#svg-a13b"></use></svg><svg class="u-svg-content" viewBox="0 0 95.333 95.332" x="0px" y="0px" id="svg-a13b" style="enable-background:new 0 0 95.333 95.332;"><g><g><path d="M30.512,43.939c-2.348-0.676-4.696-1.019-6.98-1.019c-3.527,0-6.47,0.806-8.752,1.793    c2.2-8.054,7.485-21.951,18.013-23.516c0.975-0.145,1.774-0.85,2.04-1.799l2.301-8.23c0.194-0.696,0.079-1.441-0.318-2.045    s-1.035-1.007-1.75-1.105c-0.777-0.106-1.569-0.16-2.354-0.16c-12.637,0-25.152,13.19-30.433,32.076    c-3.1,11.08-4.009,27.738,3.627,38.223c4.273,5.867,10.507,9,18.529,9.313c0.033,0.001,0.065,0.002,0.098,0.002    c9.898,0,18.675-6.666,21.345-16.209c1.595-5.705,0.874-11.688-2.032-16.851C40.971,49.307,36.236,45.586,30.512,43.939z"></path><path d="M92.471,54.413c-2.875-5.106-7.61-8.827-13.334-10.474c-2.348-0.676-4.696-1.019-6.979-1.019    c-3.527,0-6.471,0.806-8.753,1.793c2.2-8.054,7.485-21.951,18.014-23.516c0.975-0.145,1.773-0.85,2.04-1.799l2.301-8.23    c0.194-0.696,0.079-1.441-0.318-2.045c-0.396-0.604-1.034-1.007-1.75-1.105c-0.776-0.106-1.568-0.16-2.354-0.16    c-12.637,0-25.152,13.19-30.434,32.076c-3.099,11.08-4.008,27.738,3.629,38.225c4.272,5.866,10.507,9,18.528,9.312    c0.033,0.001,0.065,0.002,0.099,0.002c9.897,0,18.675-6.666,21.345-16.209C96.098,65.559,95.376,59.575,92.471,54.413z"></path></g></g></svg></span>

                    <p class="comment-text">The PVDATA tool was an original Imperial College London research. This tool combines the nexus of energy. Finance, and environment relating to renewable solar.</p>
                    <p class="customer-name">Celia Almeda</p>
                    <p class="customer-job">CEO Company</p>
                </div>
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    <span class="u-align-left u-icon u-icon-circle u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 95.333 95.332" style=""><use xlink:href="#svg-a13b"></use></svg><svg class="u-svg-content" viewBox="0 0 95.333 95.332" x="0px" y="0px" id="svg-a13b" style="enable-background:new 0 0 95.333 95.332;"><g><g><path d="M30.512,43.939c-2.348-0.676-4.696-1.019-6.98-1.019c-3.527,0-6.47,0.806-8.752,1.793    c2.2-8.054,7.485-21.951,18.013-23.516c0.975-0.145,1.774-0.85,2.04-1.799l2.301-8.23c0.194-0.696,0.079-1.441-0.318-2.045    s-1.035-1.007-1.75-1.105c-0.777-0.106-1.569-0.16-2.354-0.16c-12.637,0-25.152,13.19-30.433,32.076    c-3.1,11.08-4.009,27.738,3.627,38.223c4.273,5.867,10.507,9,18.529,9.313c0.033,0.001,0.065,0.002,0.098,0.002    c9.898,0,18.675-6.666,21.345-16.209c1.595-5.705,0.874-11.688-2.032-16.851C40.971,49.307,36.236,45.586,30.512,43.939z"></path><path d="M92.471,54.413c-2.875-5.106-7.61-8.827-13.334-10.474c-2.348-0.676-4.696-1.019-6.979-1.019    c-3.527,0-6.471,0.806-8.753,1.793c2.2-8.054,7.485-21.951,18.014-23.516c0.975-0.145,1.773-0.85,2.04-1.799l2.301-8.23    c0.194-0.696,0.079-1.441-0.318-2.045c-0.396-0.604-1.034-1.007-1.75-1.105c-0.776-0.106-1.568-0.16-2.354-0.16    c-12.637,0-25.152,13.19-30.434,32.076c-3.099,11.08-4.008,27.738,3.629,38.225c4.272,5.866,10.507,9,18.528,9.312    c0.033,0.001,0.065,0.002,0.099,0.002c9.897,0,18.675-6.666,21.345-16.209C96.098,65.559,95.376,59.575,92.471,54.413z"></path></g></g></svg></span>

                    <p class="comment-text">Proin sed libero enim sed faucibus turpis. At imperdiet dui accumsan sit amet nulla facilisi morbi tempus. Ut sem nulla pharetra diam sit amet nisl. Enim nunc</p>
                    <p class="customer-name">Celia Almeda</p>
                    <p class="customer-job">CEO Company</p>
                </div>
            </div>
        ...
        <section class="py700 section" id="blog_section" style="padding-top:20px;">
        </section>
            ...
            <div class="bg--blue-1100 c--text-inverse mw900 mx-auto py650-l py700 relative">
                <div class="mw-83p-ns mx-auto px350-ns px450 py300-l py650-m w-100p">
                    ...
                    <div class="row flex" style="justify-content: space-between; margin-top: 20px;">
                        <button class="bg-transparent bn flex hover-underline-outward items-center justify-start" on="tap:video-modal.open"  onclick="resetVideo()" >
                            ...
                            <span class="f600-l fw-extrabold">
                                <span class="line relative z1">Watch 60 sec video</span>
                            </span>
                        </button>
                        <a class="Button--large button mb0-ns mb600 mr500-ns m-t-20 w-90" id="blodStartYourFree" on="tap:full-tutorial-modal.open">Watch Full Tutorial</a>
                        <a class="Button--large button _light mb0-ns mb600 mr500-ns w-90" id="downloadFree1" target="_blank">Download for Free </a> 
                    </div>
                </div>
...
<amp-lightbox id="video-modal" class="AMPLightbox ff-proxima-nova i-amphtml-layout-nodisplay" layout="nodisplay" role="dialog" hidden="hidden" i-amphtml-layout="nodisplay">
    <div class="absolute bg--dark-translucent bottom0 flex items-center justify-center left0 right0 top0">
        <div class="relative w-100p mw750 mx-auto pa500 pa700-l bg--background-dark c--text-inverse shadow-5" style="padding: 45px 5px 5px 5px; margin-top: 60px;">
            <video controls style="width: 100%; height: auto;"  id="pvdata_video">
                <source src="{{ url('assets/PV data.mp4') }}" type="video/mp4">
                <!-- <source src="movie.ogg" type="video/ogg"> -->
                Your browser does not support the video tag.
            </video>
            <button onclick="resetVideo()" on="tap:video-modal.close" aria-label="Close this dialog window" aria-controls="video-modal" class="AMPLightbox-x bg-transparent absolute right0 top400 mr300 button-reset bn c--neutral-0 hover-c--neutral-500 db f900 lift pointer z1">
                <span class="screenreader">"Close this dialog window"</span>
            </button>
        </div>
    </div>
...
<amp-lightbox id="full-tutorial-modal" class="AMPLightbox ff-proxima-nova i-amphtml-layout-nodisplay" layout="nodisplay" role="dialog" hidden="hidden" i-amphtml-layout="nodisplay">
    <div class="absolute bg--dark-translucent bottom0 flex items-center justify-center left0 right0 top0">
        <div class="relative w-100p mw750 mx-auto pa500 pa700-l bg--background-dark c--text-inverse shadow-5" style="padding: 45px 5px 5px 5px; margin-top: 60px;">
        <!-- <iframe width="100%" height="450px" src="https://www.youtube-nocookie.com/embed/_qgEt3YhzuE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
            <iframe id="full_tutorial_video"  width="100%" height="625px" src="https://www.youtube.com/embed/_qgEt3YhzuE" title="YouTube video player" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            <button onclick="fullTutorialVideo()" on="tap:full-tutorial-modal.close" aria-label="Close this dialog window" aria-controls="video-modal" class="AMPLightbox-x bg-transparent absolute right0 top400 mr300 button-reset bn c--neutral-0 hover-c--neutral-500 db f900 lift pointer z1">
                <span class="screenreader">"Close this dialog window"</span>
            </button>
        </div>
    </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        function resetVideo()
        {
            var video = document.getElementById("pvdata_video");
            video.currentTime = 0;
            video.pause();
        }
        $('#downloadFree1').click(() => { 
            downloadLink('downloadFree1');
        })
        $('#downloadFree').click(() => {
            downloadLink('downloadFree');
        })
        function fullTutorialVideo(event) {
            if (event) {
                $("#full_tutorial_video").attr("src", video);
            }else {
                $("#full_tutorial_video").attr("src", '');
            }
        }
        $('#blodStartYourFree').click(() => {
            fullTutorialVideo('block');
        })
