        ...
        <section class="c--text-inverse py700 section bg--blue-700" style="padding: 100px 0px; height: 100%; color: white;">
            ...
            <div class="flex-wrap row h-100p">
                ...
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    ...
                    <p class="comment-text">The PVDATA tool was developed on research undertaken at Imperial College London. The tool combines the nexus of energy, finance and environment relating to renewable solar.</p>
                ...
                <div class="col w-1-3 w-100-p-sm w-50-p-md back-white my-10 border-radius-25 p-30">
                    ...
                    <p class="comment-text">PVDATAhas provided me with a holistic insight of a solar asset and its surrounding value chain. I am now able to get useful country and environmental data about my project elsewhere in the world without stepping foot in there. This tool will save me a lot of money and time.</p>
